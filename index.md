...
| Historian              | • A tool that records data from the control system. But like so many other things in the manufacturing realm, that’s not really sufficient. There are many types of historians that end-user manufacturers can use.                                        | [What is a historian?](https://www.rtautomation.com/rtas-blog/what-is-a-historian/#:~:text=A%20historian%20is%20a%20tool,end%2Duser%20manufacturers%20can%20use.&text=Each%20platform%20has%20some%20advantages%20and%20disadvantages%20for%20the%20end%2Duser.) |
